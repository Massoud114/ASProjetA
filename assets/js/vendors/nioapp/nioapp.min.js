...
var NioApp = function(i, w) {
  ...
  return w.fn.exists = function() {
    ...
    for (var s = t ? t + '-' : '', a = e ? e.split(' ') : '', o = 0; o <
    a.length; o++) a[o] = s + a[o];
  ...
  }, i.isDark = !(!o.hasClass('dark-mode') && 'dark' !==
      o.data('theme')), i.State = {
    ...
    t = t || 1;
    if (/^#([A-Fa-f0-9]{3}){1,2}$/.test(e)) return e = [
      (e = '0x' + (e = 3 === (e = e.substring(1).split('')).length ? [
        e[0],
        e[0],
        e[1],
        e[1],
        e[2],
        e[2]] : e).join('')) >> 16 & 255, e >> 8 & 255, 255 & e].join(','), 1 <=
    t ? 'rgba(' + e + ')' : 'rgba(' + e + ',' + t + ')';
    ...
    function e() {
      !0 === i.State.asMobile ? o.addClass('as-mobile') : o.removeClass(
          'as-mobile');
    }

    !0 === i.State.isTouch ? o.addClass('has-touch') : o.addClass(
        'no-touch'), e(), !0 === i.State.isRTL &&
    o.addClass('has-rtl'), o.addClass('nk-' + s), t.on('resize', e);
  }, i.ColorBG = function() {
    function e(e, t) {
      var e = w(e), t = t || 'bg', s = e.data(t);
      '' !== s &&
      ('bg-color' === t ? e.css('background-color', s) : 'bg-image' === t
    ...
    w('[data-color]').each(function() {
      var e, t;
      t = 'color', e = w(e = this), '' !== (t = e.data(t || 'color')) &&
      e.css('color', t);
    });
  }, i.BreakClass = function(e, t, s) {
    var a = e || '.header-menu', o = t || i.Break.md,
    ...
    w(e).exists() && w(e).on('click', function(e) {
      ...
      e.preventDefault(), s.hasClass(a.showClass) ? (t.add(s).
          addClass(a.hideClass).
          removeClass(a.showClass), s.attr('type', 'password')) : (t.add(s).
          addClass(a.showClass).
          removeClass(a.hideClass), s.attr('type', 'text'));
    });
    ...
    t.prefix = !1 !== t.prefix ? t.prefix : '', t.has = '' !== t.has ? t.has +
        '-' : '', e = '' !== t.class ? t.class : t.has + e, w(
        '.' + t.prefix + s).exists() && !o.hasClass(e) && o.addClass(e);
  }, i.Toggle = {
    trigger: function(e, t) {
      var s = {
            ...
            olay: 'toggle-overlay',
            speed: 400,
          }, t = t ? r(s, t) : s, s = w('[data-target=' + e + ']'),
          e = w('[data-' + t.data + '=' + e + ']'),
          a = e.data('toggle-body');
      e.data('toggle-overlay') && (t.overlay = t.olay), a &&
      (t.body = 'toggle-shown'), e.hasClass(t.content) ? (s.removeClass(
          t.active), (1 == t.toggle ? e.slideUp(t.speed) : e).removeClass(
          t.content)) : (s.addClass(t.active), (1 == t.toggle ? e.slideDown(
          t.speed) : e).addClass(t.content)), t.body &&
      o.toggleClass(t.body), t.overlay && this.overlay(e, t.overlay, t);
      ...
      var s = {
          ...
          a = e.data('toggle-body');
      e.data('toggle-overlay') && (t.overlay = t.olay), a &&
      (t.body = 'toggle-shown'), (s.hasClass(t.active) ||
          e.hasClass(t.content)) &&
      (s.removeClass(t.active), e.removeClass(t.content), !0 === t.toggle &&
      e.slideUp(t.speed)), t.body && o.hasClass(t.body) &&
      o.removeClass(t.body), t.close &&
      (!0 === t.close.profile && this.closeProfile(e), !0 === t.close.menu &&
      this.closeMenu(e)), t.overlay && this.overlayRemove(t.overlay);
    }, overlay: function(e, t, s) {
      var a;
      !0 === s.break &&
      (a = w(e).data('toggle-screen'), s.break = i.Break[a]), w(e).
          hasClass(s.content) && i.Win.width < s.break
          ? w(e).
              after(
      ...
      t.speed = 5 < e.children().length
          ? t.speed + 20 * e.children().length
          : t.speed, e.slideToggle(t.speed).
          find('.' + t.child).
          slideUp(t.speed), s.toggleClass(t.active).
          siblings().
    ...
    w(e).exists() &&
    [].slice.call(document.querySelectorAll(e || '[data-bs-toggle="tooltip"]')).
        map(function(e) {
          return new Tooltip(e, a);
        });
  }, i.BS.menutip = function(e) {
    i.BS.tooltip(e, {boundary: 'window', placement: 'right'});
  }, i.BS.popover = function(e) {
    [].slice.call(document.querySelectorAll(e || '[data-bs-toggle="popover"]')).
        map(function(e) {
    ...
    e = e || '.modal';
    w(e).exists() && 'function' == typeof w.fn.modal &&
    ...
    w(e).exists() && 'function' == typeof w.fn.datepicker &&
    w(e).each(function() {
      ...
      w(this).datepicker(e).on('changeDate', function(e) {
        0 !== e.dates.length ? w(this).parent().addClass('focused') : w(this).
            parent().
            removeClass('focused');
      });
    });
    ...
    w(e).exists() && 'function' == typeof w.fn.timepicker &&
    w(e).each(function() {
      w(this).parent().addClass('has-timepicker');
      var e = w(this).data('time-format'), t = w(this).data('time-interval'),
          e = {
            timeFormat: '' !== e ? e : 'HH:mm',
            interval: '' !== t ? t : 15,
            change: function(e) {
              !1 !== e ? w(this).parent().addClass('focused') : w(this).
                  parent().
                  removeClass('focused');
            },
          }, t = s ? r(e, s) : e;
    ...
    var t = !(!s.dataset.stepInit || isNaN(s.dataset.stepInit)) &&
        parseInt(s.dataset.stepInit), t = {
      selectors: {
    ...
    let a = s.querySelectorAll(`.${t.selectors.nav} > *`),
        ...
        n = (s.querySelector('.' + t.selectors.progress), s.querySelector(
            `.${t.selectors.progress}-count`)),
        ...
        d = t.classes.nav_current, u = t.classes.nav_done,
        h = t.classes.step_active, p = t.classes.step_done,
    ...
    function C(e) {
      ...
      1 === t &&
      (l.style.display = 'block', r.style.display = 'none', c.style.display = 'none', s.setAttribute(
          'data-step-current', 'first')), g !== t & 1 !== t &&
      (r.style.display = 'block', l.style.display = 'block', c.style.display = 'none', s.setAttribute(
          'data-step-current', t)), g === t &&
      (r.style.display = 'block', c.style.display = 'block', l.style.display = 'none', s.setAttribute(
          'data-step-current', 'last')), b &&
      (n.innerHTML = e + ' of ' + g, i.style.width = 100 / g * e + '%');
    }
    ...
    r.querySelector('button').addEventListener('click', function(e) {
      e.preventDefault();
      var e = k.form(), t = v - 1;
      e ? g !== v && (y && a[t].classList.add(u), o[t].classList.add(p)) : (y &&
      a[t].classList.remove(u), o[t].classList.remove(p)), C(--v);
    }), l.querySelector('button').addEventListener('click', function(e) {
      e.preventDefault(), k.form() &&
      (e = v - 1, y && a[e].classList.add(u), o[e].classList.add(p), C(++v));
  ...
  function n(t) {
    t = void 0 === t ? e : t, o.docReady.concat(o.docReadyDefer).
        forEach(function(e) {
          null != e && e(t);
        });
  }
  ...
  function i(t) {
    t = 'object' == typeof t ? e : t, o.winLoad.concat(o.winLoadDefer).
        forEach(function(e) {
          null != e && e(t);
        });
  }
  ...
  function r(t) {
    t = 'object' == typeof t ? e : t, o.onResize.concat(o.onResizeDefer).
        forEach(function(e) {
          null != e && e(t);
        });
  }

  return e(s).ready(n), e(t).on('load', i), e(t).
      on('resize',
          r), a.coms = o, a.docReady = n, a.winLoad = i, a.onResize = r, a;
