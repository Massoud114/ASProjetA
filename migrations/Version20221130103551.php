 ...
 */
final class Version20221130103551 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE category ADD parent_id INT DEFAULT NULL, ADD slug VARCHAR(255) DEFAULT NULL');
